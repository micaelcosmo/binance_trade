...
class BinanceStreamManager:
    ...
    def _process_stream_data(self, stream_data):# --- PATCH DE BLINDAGEM ---
        # Impede que retornos vazios ou falhas da API quebrem a thread
        if not isinstance(stream_data, dict) or "event_type" not in stream_data:
            return
